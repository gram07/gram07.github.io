		...
		<div class="col-md-8">
			<div class="card">
				<div class="card-body text-center">
					<h4 class="mb-2"><strong> OoFcuk CHecker</strong></h4>
					<textarea rows="7" class="form-control text-center form-checker mb-2" placeholder="PUT YOUR CC HERE :>"></textarea>												
...
Swal.fire({ title: "OoFcuk CHecker", text: "Ahhh Stresss:(", icon: "warning", confirmButtonText: "OK", buttonsStyling: false, confirmButtonClass: 'btn btn-primary'});
