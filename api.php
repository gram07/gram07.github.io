...
$skeys = array(
1 => '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',
);
...
elseif(strpos($result3, "lost_card" )) {
    echo '#DIE</span>  </span>CC:  '.$lista.'</span>  <br>Result: LOST CARD</span></span>  <br>Result: CHECKER  </span> <br>';
}
...
elseif(strpos($result1, "card_not_supported" )) {
    ...
    echo '#DIE</span> CC:  '.$lista.'</span>  <br>Result: GENERIC DECLINE </span><br>';
